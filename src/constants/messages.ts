...
const enum Messages {
  ...
  winemakingReqErr = 'Missing required winemaking field',
  grapeVarietiesReqErr = 'Missing required grape varieties field',
  tastingNotesReqErr = 'Missing required tasting notes field',
  storeAndServeAdvicesReqErr = 'Missing required store and serve advices field',
  foodPairingReqErr = 'Missing required food pairing field',
  reviewsAndAwardsReqErr = 'Missing required reviews and awards field',
